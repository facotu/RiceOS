...
export const INITIAL_STAFF: StaffMember[] = [
  ...
  {
    id: 'stf-02',
    user_id: 'usr-editor-01',
    full_name: 'Cán Bộ Cân Lê Văn Cường',
    phone: '0977333444',
    created_at: '2026-08-02T08:00:00Z',
  }
];
...
export const INITIAL_SESSIONS: WeighingSession[] = [
  {
    ...
    total_tare_weight: 50,
    total_dry_weight: 1200,
    total_bags: 25,
    unit_price: 9500,
    total_amount: 11400000,
    status: 'completed',
    started_at: '2026-08-12T07:30:00Z',
    completed_at: '2026-08-12T08:45:00Z',
    notes: 'Lúa đẹp, độ ẩm chuẩn 14%',
    farmer: INITIAL_FARMERS[0],
    staff: INITIAL_STAFF[0],
    truck: INITIAL_TRUCKS[0],
    variety: INITIAL_VARIETIES[0],
    items: [
      { id: 'itm-01', session_id: 'ses-01', sequence: 1, bag_count: 3, gross_weight: 150, tare_weight: 6, net_weight: 144, weighed_at: '2026-08-12T07:35:00Z' },
      { id: 'itm-02', session_id: 'ses-01', sequence: 2, bag_count: 3, gross_weight: 152, tare_weight: 6, net_weight: 146, weighed_at: '2026-08-12T07:42:00Z' },
      { id: 'itm-03', session_id: 'ses-01', sequence: 3, bag_count: 2, gross_weight: 98, tare_weight: 4, net_weight: 94, weighed_at: '2026-08-12T07:50:00Z' }
    ]
  },
  {
    id: 'ses-02',
    ...
    total_tare_weight: 80,
    total_dry_weight: 2020,
    total_bags: 40,
    unit_price: 8200,
    total_amount: 16564000,
    status: 'completed',
    started_at: '2026-08-12T09:00:00Z',
    completed_at: '2026-08-12T10:30:00Z',
    notes: 'Đã hoàn thành xuất cho xe 92C-123.45',
    farmer: INITIAL_FARMERS[1],
    staff: INITIAL_STAFF[0],
    truck: INITIAL_TRUCKS[0],
    variety: INITIAL_VARIETIES[1],
    items: [
      { id: 'itm-04', session_id: 'ses-02', sequence: 1, bag_count: 3, gross_weight: 155, tare_weight: 6, net_weight: 149, weighed_at: '2026-08-12T09:10:00Z' }
    ]
  },
  {
    id: 'ses-03',
    ...
    total_tare_weight: 120,
    total_dry_weight: 2980,
    total_bags: 60,
    unit_price: 8500,
    total_amount: 25330000,
    status: 'completed',
    started_at: '2026-08-12T11:00:00Z',
    completed_at: '2026-08-12T12:45:00Z',
    notes: 'Đã giao đủ hàng cho xe 43H-678.90',
